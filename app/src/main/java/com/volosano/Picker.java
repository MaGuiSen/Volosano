...
import lib.widget.PickTimeView;
import lib.widget.PickValueView;

public class Picker extends AppCompatActivity implements PickTimeView.onSelectedChangeListener, PickValueView.onSelectedChangeListener {
    LinearLayout pvLayout;
    PickTimeView pickTime;
    PickTimeView pickDate;

    PickValueView pickValue;
    PickValueView pickValue2;
    PickValueView pickValue3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickValue2 = (PickValueView) findViewById(R.id.pickValue2);

        pickValue3 = (PickValueView) findViewById(R.id.pickValue3);
        ...
        pickValue3.setOnSelectedChangeListener(this);
        pickValue2.setOnSelectedChangeListener(this);
    ...
    private void initData() {
        ...
        pickValue2.setValueData(value, value[4]);
        pickValue3.setValueData(value, value[4]);
//        pickValues.setValueData(value, value[0], middle, middle[0], right, right[0]);
    ...
    public void onSelected(PickValueView view, Object leftValue, Object middleValue, Object rightValue) {
        if (view == pickValue || view == pickValue2 || view == pickValue3 ) {
    ...
    public void btnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.Main_btnValue:
                showView(pickValue);
                pickValue2.setVisibility(View.VISIBLE);
                pickValue3.setVisibility(View.VISIBLE);
                break;
